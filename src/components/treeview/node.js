...
class TreeNode extends React.Component {
    ...
    renderHeader(decorators, animations) {
        const {node, style, canvas, position} = this.props;
    ...
    renderChildren(decorators) {
        const {animations, decorators: propDecorators, node, style, canvas, position} = this.props;
        ...
        return (
            <ul style={style.subtree}
                ...
                {children.map((child, index) => <TreeNode position={position}
                                                          canvas={canvas}
                                                          {...this._eventBubbles()}
                                                          animations={animations}
